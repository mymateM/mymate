...
class BillListContainerAdapter(val billList: ArrayList<ArrayList<BillSummary>>, val category: String): RecyclerView.Adapter<BillListContainerAdapter.BillListContainerHolder>() {
