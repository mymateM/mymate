...
class MainReportHouseholdFragment: Fragment() {
    ...
    private fun initPieRecycle(categoryName: ArrayList<String>, categoryRatio: ArrayList<Float>, categoryAbs: ArrayList<Int>, total: Int) {
        ...
        piemidtext.setSpan(ForegroundColorSpan(ContextCompat.getColor(mainActivity, R.color.graydark_text)), 0, 5, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
        piemidtext.setSpan(ForegroundColorSpan(ContextCompat.getColor(mainActivity, R.color.black_text)), 5, piemidtext.lastIndex, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
